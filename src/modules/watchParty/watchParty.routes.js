...
router.get("/rooms/accessible-live", controller.listAccessibleLiveRooms);
router.get("/rooms/profile/:username/live", controller.getProfileLiveRoom);
...
router.post("/rooms/:roomId/reset-code", controller.resetInviteCode);
